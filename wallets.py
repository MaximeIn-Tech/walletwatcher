...
async def fetch_data_contract(contract_address):
...
async def fetch_theta_single_wallet_balance(wallet_address, contract_address):
...
async def fetch_theta_stake(wallet_address):
...
async def fetch_eth_balance_multiple_addresses(wallet_addresses):
...
async def fetch_eth_single_wallet_balance(wallet_addresse, contract_address):
...
async def fetch_bsc_single_wallet_balance(wallet_addresse, contract_address):
...
async def fetch_bnb_balance_multiple_addresses(wallet_addresses):
